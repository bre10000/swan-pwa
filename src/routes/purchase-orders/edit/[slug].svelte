...
import { createActivityLog } from "../../../utils/activity/log";
    ...
    async function add() {
        ...
        try {
            let params = {
                populate : [ 'consortium_member', 'purchase_order_items', 'purchase_order_items.item']
            };
            ...
            if (response.data?.id) {
                ...
                createActivityLog("Purchase Order", response.data, "Edit", response.data.id)
    ...
    async function deleteItem() {
        ...
        try {
            ...
            if (response.data?.id) {
                ...
                createActivityLog("Purchase Order Item", currentItem, "Delete", currentItem.id)
    ...
    async function getItem() {
        try {
            ...
            childItemsExisting =
                response.data.attributes.purchase_order_items.data;
        } catch (e) {
        ...
        {#each childItemsExisting as child}
            <div class="columns">
                ...
                <div class="column is-3">
                    {child.attributes.item?.data?.attributes.name} <br />
                ...
                <div class="column has-text-centered">
                    ...
                    <br />
                    {numberWithCommas(
                        child.attributes.unitPrice * child.attributes.quantity
                    )}
                </div>
                <div class="column has-text-right is-flex">
                    <a
                        href="purchase-orders/edit-item/{child.id}"
